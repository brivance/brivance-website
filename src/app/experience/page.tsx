    ...
    <>
      ...
      <div className="mt-14 mx-24 flex flex-col gap-12">
        <ExperienceCard
          ...
          description="I am a full stack developer with a passion for building scalable and efficient web applications. I have experience working with various technologies such as React, Next.js, Node.js, and GraphQL. I am also proficient in JavaScript, TypeScript, and CSS. My skills include front-end development, back-end development, and database management."
          moreInformation={
            <p className="">
              <strong>Tools:</strong> Next.js, NextAuth, React, Prisma ORM, PostgreSQL, TypeScript, Tailwind CSS
            </p>
          }
