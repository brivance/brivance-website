...
const FunLinkCard = ({ title, description, image, href }: Props) => {
  return (
    <a href={href} className="flex flex-col justify-start gap-6 items-center border border-gray-300 rounded-sm shadow-lg transition-transform duration-300 hover:scale-110">
