    ...
    <>
      ...
      <div>
        <div className="grid grid-cols-3 gap-6 w-11/12 mb-28 items-center mx-auto">
          ...
          <a className="bg-white flex flex-col gap-4 justify-start items-center border border-white rounded-sm shadow-lg transition-transform duration-300 hover:scale-110">
          ...
          <a className="bg-white flex flex-col gap-1 justify-start items-center border border-white rounded-sm shadow-lg transition-transform duration-300 hover:scale-110">
