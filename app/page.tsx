...
function Hero() {
  return (
    <div className={`bg-yellow w-full min-h-screen pt-10`}>
      <div className="flex justify-between mx-auto w-5/7 min-h-[70vh] items-center gap-[10%]">
        <div className="flex flex-col justify-between min-h-[60vh]">
          <div className={`${kalnia.className} flex flex-col justify-start text-[8rem] gap-0 tracking-tight leading-tight -mt-3`}>
            <span>BRIANNA</span>
...
function Projects() {
  return (
    <div className="bg-white w-full pt-40">
      ...
      <div className="flex flex-row gap-[5%] justify-between w-5/7 mx-auto mt-16 mb-54">
        <video
          className="w-1/2"
          // preload="metadata"
          autoPlay
